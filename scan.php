...
<center>
    <span  style="font-size: 50px; font-family: time;"><?= $body_temp;?>0°</span><span><br>degrees</span>
</center>
...
<div class="panel-body">
<center><span  style="font-size: 50px; font-family: time;"><?= $heart_beat;?></span><span><br>bpm</span></center>
<hr />
...
<font color="red" align="center"><?php// echo htmlentities($_SESSION['msg']);?><?php //echo htmlentities($_SESSION['msg']="");?></font>
<div class="panel-body">
<center><span  style="font-size: 50px; font-family: time;"><?= $room_temperature;?>°</span><span><br>degrees</span></center>
<hr />
...
<font color="red" align="center"><?php// echo htmlentities($_SESSION['msg']);?><?php //echo htmlentities($_SESSION['msg']="");?></font>
<div class="panel-body">
<center><span  style="font-size: 50px; font-family: time;"><?= $room_humidity;?></span><span style="font-size: 20px;"><br>%</span></center>
